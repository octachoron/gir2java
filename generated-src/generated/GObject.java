...
import generated.gobject20.gobject.GSignalMatchType;
...
public class GObject {
    ...
    @Ptr
    protected static native long g_type_default_interface_peek(long g_type);

    public static Pointer<GTypeInterface> type_default_interface_peek(long g_type) {
        return Pointer.pointerToAddress(GObject.g_type_default_interface_peek(g_type), GTypeInterface.class);
    }
    ...
    protected static native void g_signal_handler_disconnect(
        @Ptr
        long instance, long handler_id);

    public static void signal_handler_disconnect(Pointer<generated.gobject20.gobject.GObject> instance, long handler_id) {
        GObject.g_signal_handler_disconnect(Pointer.getPeer(instance), handler_id);
    }
    ...
    protected static native void g_type_default_interface_unref(
        @Ptr
        long g_iface);

    public static void type_default_interface_unref(Pointer<GTypeInterface> g_iface) {
        GObject.g_type_default_interface_unref(Pointer.getPeer(g_iface));
    }
    ...
    protected static native boolean g_signal_has_handler_pending(
        @Ptr
        long instance, long signal_id, long detail, boolean may_be_blocked);

    public static boolean signal_has_handler_pending(Pointer<generated.gobject20.gobject.GObject> instance, long signal_id, long detail, boolean may_be_blocked) {
        return GObject.g_signal_has_handler_pending(Pointer.getPeer(instance), signal_id, detail, may_be_blocked);
    }
    ...
    protected static native void g_signal_handler_block(
        @Ptr
        long instance, long handler_id);

    public static void signal_handler_block(Pointer<generated.gobject20.gobject.GObject> instance, long handler_id) {
        GObject.g_signal_handler_block(Pointer.getPeer(instance), handler_id);
    }
    ...
    protected static native long g_signal_handlers_unblock_matched(
        @Ptr
        long instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail,
        @Ptr
        long closure,
        @Ptr
        long func,
    ...
    public static long signal_handlers_unblock_matched(Pointer<generated.gobject20.gobject.GObject> instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail, Pointer<GClosure> closure, Pointer func, Pointer data) {
        return GObject.g_signal_handlers_unblock_matched(Pointer.getPeer(instance), mask, signal_id, detail, Pointer.getPeer(closure), Pointer.getPeer(func), Pointer.getPeer(data));
    }
    ...
    protected static native void g_signal_emit_by_name(
        @Ptr
        long instance,
        @Ptr
        long detailed_signal, Object... varargs);

    public static void signal_emit_by_name(Pointer<generated.gobject20.gobject.GObject> instance, Pointer detailed_signal, Object... varargs) {
        GObject.g_signal_emit_by_name(Pointer.getPeer(instance), Pointer.getPeer(detailed_signal), varargs);
    }
    ...
    protected static native void g_signal_handler_unblock(
        @Ptr
        long instance, long handler_id);

    public static void signal_handler_unblock(Pointer<generated.gobject20.gobject.GObject> instance, long handler_id) {
        GObject.g_signal_handler_unblock(Pointer.getPeer(instance), handler_id);
    }
    ...
    protected static native void g_signal_stop_emission_by_name(
        @Ptr
        long instance,
        @Ptr
        long detailed_signal);

    public static void signal_stop_emission_by_name(Pointer<generated.gobject20.gobject.GObject> instance, Pointer detailed_signal) {
        GObject.g_signal_stop_emission_by_name(Pointer.getPeer(instance), Pointer.getPeer(detailed_signal));
    }
    ...
    protected static native void g_signal_emit(
        @Ptr
        long instance, long signal_id, long detail, Object... varargs);

    public static void signal_emit(Pointer<generated.gobject20.gobject.GObject> instance, long signal_id, long detail, Object... varargs) {
        GObject.g_signal_emit(Pointer.getPeer(instance), signal_id, detail, varargs);
    }
    ...
    protected static native long g_signal_connect_data(
        @Ptr
        long instance,
        @Ptr
        long detailed_signal,
        ...
        long data,
        @Ptr
        long destroy_data, IntValuedEnum<GConnectFlags> connect_flags);

    public static long signal_connect_data(Pointer<generated.gobject20.gobject.GObject> instance, Pointer detailed_signal, Pointer c_handler, Pointer data, Pointer destroy_data, IntValuedEnum<GConnectFlags> connect_flags) {
        return GObject.g_signal_connect_data(Pointer.getPeer(instance), Pointer.getPeer(detailed_signal), Pointer.getPeer(c_handler), Pointer.getPeer(data), Pointer.getPeer(destroy_data), connect_flags);
    }
    ...
    protected static native boolean g_signal_handler_is_connected(
        @Ptr
        long instance, long handler_id);

    public static boolean signal_handler_is_connected(Pointer<generated.gobject20.gobject.GObject> instance, long handler_id) {
        return GObject.g_signal_handler_is_connected(Pointer.getPeer(instance), handler_id);
    }
    ...
    protected static native long g_signal_connect_closure(
        @Ptr
        long instance,
        @Ptr
        long detailed_signal,
    ...
    public static long signal_connect_closure(Pointer<generated.gobject20.gobject.GObject> instance, Pointer detailed_signal, Pointer<GClosure> closure, boolean after) {
        return GObject.g_signal_connect_closure(Pointer.getPeer(instance), Pointer.getPeer(detailed_signal), Pointer.getPeer(closure), after);
    }
    ...
    protected static native long g_signal_handlers_block_matched(
        @Ptr
        long instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail,
        @Ptr
        long closure,
    ...
    public static long signal_handlers_block_matched(Pointer<generated.gobject20.gobject.GObject> instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail, Pointer<GClosure> closure, Pointer func, Pointer data) {
        return GObject.g_signal_handlers_block_matched(Pointer.getPeer(instance), mask, signal_id, detail, Pointer.getPeer(closure), Pointer.getPeer(func), Pointer.getPeer(data));
    }
    ...
    @Ptr
    protected static native long g_signal_get_invocation_hint(
        @Ptr
        long instance);

    public static Pointer<GSignalInvocationHint> signal_get_invocation_hint(Pointer<generated.gobject20.gobject.GObject> instance) {
        return Pointer.pointerToAddress(GObject.g_signal_get_invocation_hint(Pointer.getPeer(instance)), GSignalInvocationHint.class);
    }
    ...
    protected static native long g_signal_handler_find(
        @Ptr
        long instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail,
        @Ptr
        long closure,
    ...
    public static long signal_handler_find(Pointer<generated.gobject20.gobject.GObject> instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail, Pointer<GClosure> closure, Pointer func, Pointer data) {
        return GObject.g_signal_handler_find(Pointer.getPeer(instance), mask, signal_id, detail, Pointer.getPeer(closure), Pointer.getPeer(func), Pointer.getPeer(data));
    }
    ...
    public static Pointer<GTypeClass> type_class_ref(long type) {
        return Pointer.pointerToAddress(GObject.g_type_class_ref(type), GTypeClass.class);
    }
    ...
    protected static native long g_signal_connect_closure_by_id(
        @Ptr
        long instance, long signal_id, long detail,
        @Ptr
        long closure, boolean after);

    public static long signal_connect_closure_by_id(Pointer<generated.gobject20.gobject.GObject> instance, long signal_id, long detail, Pointer<GClosure> closure, boolean after) {
        return GObject.g_signal_connect_closure_by_id(Pointer.getPeer(instance), signal_id, detail, Pointer.getPeer(closure), after);
    }

    @Ptr
    protected static native long g_type_default_interface_ref(long g_type);

    public static Pointer<GTypeInterface> type_default_interface_ref(long g_type) {
        return Pointer.pointerToAddress(GObject.g_type_default_interface_ref(g_type), GTypeInterface.class);
    }
    ...
    protected static native void g_signal_stop_emission(
        @Ptr
        long instance, long signal_id, long detail);

    public static void signal_stop_emission(Pointer<generated.gobject20.gobject.GObject> instance, long signal_id, long detail) {
        GObject.g_signal_stop_emission(Pointer.getPeer(instance), signal_id, detail);
    }
    ...
    public static Pointer<GTypeClass> type_class_peek(long type) {
        return Pointer.pointerToAddress(GObject.g_type_class_peek(type), GTypeClass.class);
    }

    @Ptr
    protected static native long g_type_class_peek_static(long type);

    public static Pointer<GTypeClass> type_class_peek_static(long type) {
        return Pointer.pointerToAddress(GObject.g_type_class_peek_static(type), GTypeClass.class);
    }

    protected static native long g_signal_handlers_disconnect_matched(
        @Ptr
        long instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail,
        @Ptr
        long closure,
    ...
    public static long signal_handlers_disconnect_matched(Pointer<generated.gobject20.gobject.GObject> instance, IntValuedEnum<GSignalMatchType> mask, long signal_id, long detail, Pointer<GClosure> closure, Pointer func, Pointer data) {
        return GObject.g_signal_handlers_disconnect_matched(Pointer.getPeer(instance), mask, signal_id, detail, Pointer.getPeer(closure), Pointer.getPeer(func), Pointer.getPeer(data));
    }
    ...
    public static Pointer<GTypeInterface> type_interface_peek(Pointer<GTypeClass> instance_class, long iface_type) {
        return Pointer.pointerToAddress(GObject.g_type_interface_peek(Pointer.getPeer(instance_class), iface_type), GTypeInterface.class);
    }
    ...
    protected static native void g_signal_handlers_destroy(
        @Ptr
        long instance);

    public static void signal_handlers_destroy(Pointer<generated.gobject20.gobject.GObject> instance) {
        GObject.g_signal_handlers_destroy(Pointer.getPeer(instance));
    }
