    ...
    extends StructObject
{
    ...
    @Field(0)
    public GApplicationCommandLineClass field_parent_class(GObjectClass field_parent_class) {
    ...
    @Field(1)
    public GApplicationCommandLineClass field_padding(Pointer field_padding) {
