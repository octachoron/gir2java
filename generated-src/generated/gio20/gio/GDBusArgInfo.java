    ...
    extends StructObject
{
    ...
    @Field(3)
    public GDBusArgInfo field_annotations(Pointer<GDBusAnnotationInfo> field_annotations) {
    ...
    public Pointer ref() {
        return Pointer.pointerToAddress(this.g_dbus_arg_info_ref(Pointer.pointerTo(this, GDBusArgInfo.class)));
    }
    ...
    public void unref() {
        this.g_dbus_arg_info_unref(Pointer.pointerTo(this, GDBusArgInfo.class));
    }
