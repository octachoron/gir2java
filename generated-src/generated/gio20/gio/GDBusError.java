...
public enum GDBusError
    implements IntValuedEnum<GDBusError>
{
    ...
    public static IntValuedEnum<GDBusError> fromValue(long value) {
    ...
    public Pointer encode_gerror(Pointer<GError> error) {
    ...
    public Pointer get_remote_error(Pointer<GError> error) {
    ...
    public boolean is_remote_error(Pointer<GError> error) {
    ...
    public Pointer<GError> new_for_dbus_error(Pointer dbus_error_name, Pointer dbus_error_message) {
    ...
    public boolean register_error(Object error_domain, int error_code, Pointer dbus_error_name) {
    ...
    public void register_error_domain(Pointer error_domain_quark_name, Pointer<Long> quark_volatile, Pointer entries, long num_entries) {
    ...
    protected native void g_dbus_error_set_dbus_error(
        @Ptr
        long error,
        @Ptr
        long dbus_error_name,
    ...
    public void set_dbus_error(Pointer<Pointer<GError>> error, Pointer dbus_error_name, Pointer dbus_error_message, Pointer format, Object... varargs) {
        this.g_dbus_error_set_dbus_error(Pointer.getPeer(error), Pointer.getPeer(dbus_error_name), Pointer.getPeer(dbus_error_message), Pointer.getPeer(format), varargs);
    }
    ...
    public boolean strip_remote_error(Pointer<GError> error) {
    ...
    public boolean unregister_error(Object error_domain, int error_code, Pointer dbus_error_name) {
