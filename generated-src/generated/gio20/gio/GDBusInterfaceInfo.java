    ...
    extends StructObject
{
    ...
    @Field(5)
    public GDBusInterfaceInfo field_annotations(Pointer<GDBusAnnotationInfo> field_annotations) {
    ...
    public void cache_build() {
        this.g_dbus_interface_info_cache_build(Pointer.pointerTo(this, GDBusInterfaceInfo.class));
    }
    ...
    public void cache_release() {
        this.g_dbus_interface_info_cache_release(Pointer.pointerTo(this, GDBusInterfaceInfo.class));
    }
    ...
    public void generate_xml(long indent, Pointer<GString> string_builder) {
        this.g_dbus_interface_info_generate_xml(Pointer.pointerTo(this, GDBusInterfaceInfo.class), indent, Pointer.getPeer(string_builder));
    }
    ...
    public Pointer lookup_method(Pointer name) {
        return Pointer.pointerToAddress(this.g_dbus_interface_info_lookup_method(Pointer.pointerTo(this, GDBusInterfaceInfo.class), Pointer.getPeer(name)));
    }
    ...
    public Pointer lookup_property(Pointer name) {
        return Pointer.pointerToAddress(this.g_dbus_interface_info_lookup_property(Pointer.pointerTo(this, GDBusInterfaceInfo.class), Pointer.getPeer(name)));
    }
    ...
    public Pointer lookup_signal(Pointer name) {
        return Pointer.pointerToAddress(this.g_dbus_interface_info_lookup_signal(Pointer.pointerTo(this, GDBusInterfaceInfo.class), Pointer.getPeer(name)));
    }
    ...
    public Pointer ref() {
        return Pointer.pointerToAddress(this.g_dbus_interface_info_ref(Pointer.pointerTo(this, GDBusInterfaceInfo.class)));
    }
    ...
    public void unref() {
        this.g_dbus_interface_info_unref(Pointer.pointerTo(this, GDBusInterfaceInfo.class));
    }
