    ...
    extends StructObject
{
    ...
    @Field(1)
    public Pointer field_vfunc_padding() {
        return this.io.getPointerField(this, 1);
    }

    @Field(1)
    public GDBusInterfaceSkeletonClass field_vfunc_padding(Pointer field_vfunc_padding) {
        this.io.setPointerField(this, 1, field_vfunc_padding);
        return this;
    }

    @Field(2)
    public Pointer field_signal_padding() {
        return this.io.getPointerField(this, 2);
    }

    @Field(2)
    public GDBusInterfaceSkeletonClass field_signal_padding(Pointer field_signal_padding) {
