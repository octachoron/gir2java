    ...
    extends StructObject
{
    ...
    @Field(0)
    public GDBusObjectManagerServerClass field_parent_class(GObjectClass field_parent_class) {
    ...
    @Field(1)
    private GDBusObjectManagerServerClass field_padding(Pointer field_padding) {
