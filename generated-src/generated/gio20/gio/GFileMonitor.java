    ...
    extends GObject
{
    ...
    public boolean cancel() {
        return this.g_file_monitor_cancel(Pointer.pointerTo(this, GFileMonitor.class));
    }
    ...
    public boolean is_cancelled() {
        return this.g_file_monitor_is_cancelled(Pointer.pointerTo(this, GFileMonitor.class));
    }
    ...
    public void set_rate_limit(int limit_msecs) {
        this.g_file_monitor_set_rate_limit(Pointer.pointerTo(this, GFileMonitor.class), limit_msecs);
    }
    ...
    @Field(0)
    public GFileMonitor field_parent_instance(GObject field_parent_instance) {
    ...
    @Field(1)
    public GFileMonitor field_priv(Pointer field_priv) {
    ...
    public void emit_event(Pointer<Object> child, Pointer<Object> other_file, IntValuedEnum<GFileMonitorEvent> event_type) {
        this.g_file_monitor_emit_event(Pointer.pointerTo(this, GFileMonitor.class), Pointer.getPeer(child), Pointer.getPeer(other_file), event_type);
    }
