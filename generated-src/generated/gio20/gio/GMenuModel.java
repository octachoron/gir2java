    ...
    extends GObject
{
    ...
    public boolean get_item_attribute(int item_index, Pointer attribute, Pointer format_string, Object... varargs) {
        return this.g_menu_model_get_item_attribute(Pointer.pointerTo(this, GMenuModel.class), item_index, Pointer.getPeer(attribute), Pointer.getPeer(format_string), varargs);
    }
    ...
    public Pointer<GVariant> get_item_attribute_value(int item_index, Pointer attribute, Pointer<GVariantType> expected_type) {
        return Pointer.pointerToAddress(this.g_menu_model_get_item_attribute_value(Pointer.pointerTo(this, GMenuModel.class), item_index, Pointer.getPeer(attribute), Pointer.getPeer(expected_type)), Pointer.class);
    }
    ...
    public Pointer get_item_link(int item_index, Pointer link) {
        return Pointer.pointerToAddress(this.g_menu_model_get_item_link(Pointer.pointerTo(this, GMenuModel.class), item_index, Pointer.getPeer(link)));
    }
    ...
    public int get_n_items() {
        return this.g_menu_model_get_n_items(Pointer.pointerTo(this, GMenuModel.class));
    }
    ...
    public boolean is_mutable() {
        return this.g_menu_model_is_mutable(Pointer.pointerTo(this, GMenuModel.class));
    }
    ...
    public void items_changed(int position, int removed, int added) {
        this.g_menu_model_items_changed(Pointer.pointerTo(this, GMenuModel.class), position, removed, added);
    }
    ...
    public Pointer<GMenuAttributeIter> iterate_item_attributes(int item_index) {
        return Pointer.pointerToAddress(this.g_menu_model_iterate_item_attributes(Pointer.pointerTo(this, GMenuModel.class), item_index), Pointer.class);
    }
    ...
    public Pointer<GMenuLinkIter> iterate_item_links(int item_index) {
        return Pointer.pointerToAddress(this.g_menu_model_iterate_item_links(Pointer.pointerTo(this, GMenuModel.class), item_index), Pointer.class);
    }
