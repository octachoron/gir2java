    ...
    extends GObject
{
    ...
    public boolean get_anonymous() {
        return this.g_mount_operation_get_anonymous(Pointer.pointerTo(this, GMountOperation.class));
    }
    ...
    public int get_choice() {
        return this.g_mount_operation_get_choice(Pointer.pointerTo(this, GMountOperation.class));
    }
    ...
    public Pointer get_domain() {
        return Pointer.pointerToAddress(this.g_mount_operation_get_domain(Pointer.pointerTo(this, GMountOperation.class)));
    }
    ...
    public Pointer get_password() {
        return Pointer.pointerToAddress(this.g_mount_operation_get_password(Pointer.pointerTo(this, GMountOperation.class)));
    }
    ...
    public Pointer get_username() {
        return Pointer.pointerToAddress(this.g_mount_operation_get_username(Pointer.pointerTo(this, GMountOperation.class)));
    }
    ...
    public void set_anonymous(boolean anonymous) {
        this.g_mount_operation_set_anonymous(Pointer.pointerTo(this, GMountOperation.class), anonymous);
    }
    ...
    public void set_choice(int choice) {
        this.g_mount_operation_set_choice(Pointer.pointerTo(this, GMountOperation.class), choice);
    }
    ...
    public void set_domain(Pointer domain) {
        this.g_mount_operation_set_domain(Pointer.pointerTo(this, GMountOperation.class), Pointer.getPeer(domain));
    }
    ...
    public void set_password(Pointer password) {
        this.g_mount_operation_set_password(Pointer.pointerTo(this, GMountOperation.class), Pointer.getPeer(password));
    }
    ...
    public void set_username(Pointer username) {
        this.g_mount_operation_set_username(Pointer.pointerTo(this, GMountOperation.class), Pointer.getPeer(username));
    }
    ...
    public IntValuedEnum<GPasswordSave> get_password_save() {
        return this.g_mount_operation_get_password_save(Pointer.pointerTo(this, GMountOperation.class));
    }
    ...
    public void reply(IntValuedEnum<GMountOperationResult> result) {
        this.g_mount_operation_reply(Pointer.pointerTo(this, GMountOperation.class), result);
    }
    ...
    public void set_password_save(IntValuedEnum<GPasswordSave> save) {
        this.g_mount_operation_set_password_save(Pointer.pointerTo(this, GMountOperation.class), save);
    }
