    ...
    extends GObject
{
    ...
    public void add_button(Pointer label, Pointer detailed_action) {
        this.g_notification_add_button(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(label), Pointer.getPeer(detailed_action));
    }
    ...
    public void add_button_with_target(Pointer label, Pointer action, Pointer target_format, Object... varargs) {
        this.g_notification_add_button_with_target(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(label), Pointer.getPeer(action), Pointer.getPeer(target_format), varargs);
    }
    ...
    public void add_button_with_target_value(Pointer label, Pointer action, Pointer<GVariant> target) {
        this.g_notification_add_button_with_target_value(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(label), Pointer.getPeer(action), Pointer.getPeer(target));
    }
    ...
    public void set_body(Pointer body) {
        this.g_notification_set_body(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(body));
    }
    ...
    public void set_default_action(Pointer detailed_action) {
        this.g_notification_set_default_action(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(detailed_action));
    }
    ...
    public void set_default_action_and_target(Pointer action, Pointer target_format, Object... varargs) {
        this.g_notification_set_default_action_and_target(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(action), Pointer.getPeer(target_format), varargs);
    }
    ...
    public void set_default_action_and_target_value(Pointer action, Pointer<GVariant> target) {
        this.g_notification_set_default_action_and_target_value(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(action), Pointer.getPeer(target));
    }
    ...
    public void set_icon(Pointer<Object> icon) {
        this.g_notification_set_icon(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(icon));
    }
    ...
    public void set_title(Pointer title) {
        this.g_notification_set_title(Pointer.pointerTo(this, GNotification.class), Pointer.getPeer(title));
    }
    ...
    public void set_urgent(boolean urgent) {
        this.g_notification_set_urgent(Pointer.pointerTo(this, GNotification.class), urgent);
    }
