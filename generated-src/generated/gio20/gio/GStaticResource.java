    ...
    extends StructObject
{
    ...
    public GStaticResource field_data_len(long field_data_len) {
        this.io.setNativeObjectField(this, 1, field_data_len);
        return this;
    }
    ...
    public GStaticResource field_padding(Pointer field_padding) {
        this.io.setNativeObjectField(this, 4, field_padding);
        return this;
    }
    ...
    public void fini() {
        this.g_static_resource_fini(Pointer.pointerTo(this, GStaticResource.class));
    }
    ...
    public Pointer<GResource> get_resource() {
        return Pointer.pointerToAddress(this.g_static_resource_get_resource(Pointer.pointerTo(this, GStaticResource.class)), Pointer.class);
    }
    ...
    public void init() {
        this.g_static_resource_init(Pointer.pointerTo(this, GStaticResource.class));
    }
