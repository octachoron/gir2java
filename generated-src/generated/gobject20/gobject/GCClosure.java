    ...
    extends StructObject
{
    ...
    @Field(0)
    public Pointer gcclosure_field_callback() {
        return this.io.getPointerField(this, 0);
    }

    @Field(0)
    public GCClosure gcclosure_field_callback(Pointer gcclosure_field_callback) {
        this.io.setPointerField(this, 0, gcclosure_field_callback);
        return this;
    }
    ...
    @Field(1)
    public GClosure gcclosure_field_closure() {
        return this.io.getNativeObjectField(this, 1);
    }

    @Field(1)
    public GCClosure gcclosure_field_closure(GClosure gcclosure_field_closure) {
        this.io.setNativeObjectField(this, 1, gcclosure_field_closure);
        return this;
    }
