    ...
    extends StructObject
{
    ...
    @Field(0)
    private GObjectClass field_pdummy(Pointer field_pdummy) {
    ...
    @Field(1)
    private GObjectClass field_flags(long field_flags) {
    ...
    @Field(3)
    private GObjectClass field_construct_properties(Pointer<GSList> field_construct_properties) {
