    ...
    extends GstObject
{
    ...
    public static Pointer gstbus__new() {
    ...
    public boolean async_signal_func(Pointer<GstMessage> message, Pointer data) {
    ...
    public Pointer<GstMessage> peek() {
        return Pointer.pointerToAddress(this.gst_bus_peek(Pointer.pointerTo(this, GstBus.class).getPeer()), GstMessage.class);
    }
    ...
    public Pointer<GstMessage> pop() {
        return Pointer.pointerToAddress(this.gst_bus_pop(Pointer.pointerTo(this, GstBus.class).getPeer()), GstMessage.class);
    }
    ...
    public boolean post(Pointer<GstMessage> message) {
    ...
    public Pointer<GstMessage> timed_pop(long timeout) {
        return Pointer.pointerToAddress(this.gst_bus_timed_pop(Pointer.pointerTo(this, GstBus.class).getPeer(), timeout), GstMessage.class);
    }
    ...
    public GstBus gstbus_field_object(GstObject gstbus_field_object) {
        this.io.setNativeObjectField(this, 0, gstbus_field_object);
        return this;
    }

    @Field(1)
    private Pointer<GstBusPrivate> field_priv() {
        return this.io.getPointerField(this, 1);
    }

    @Field(1)
    private GstBus field_priv(Pointer<GstBusPrivate> field_priv) {
