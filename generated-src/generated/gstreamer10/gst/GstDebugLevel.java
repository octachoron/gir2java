...
public enum GstDebugLevel implements IntValuedEnum<GstDebugLevel>
{
    ...
    public static IntValuedEnum<GstDebugLevel> fromValue(int value) {
        return FlagSet.fromValue(value, GstDebugLevel.values());
    }

    @Ptr
    protected static native long gst_debug_level_get_name(IntValuedEnum<GstDebugLevel> level);

    public static Pointer get_name(IntValuedEnum<GstDebugLevel> level) {
        return Pointer.pointerToAddress(GstDebugLevel.gst_debug_level_get_name(level));
    }
