...
public enum GstEventType
    implements IntValuedEnum<GstEventType>
{
    ...
    public static IntValuedEnum<GstEventType> fromValue(long value) {
    ...
    public Pointer get_name(IntValuedEnum<GstEventType> type) {
