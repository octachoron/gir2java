    ...
    extends StructObject
{
    ...
    public GstPluginDesc field_major_version(int field_major_version) {
        this.io.setIntField(this, 0, field_major_version);
        return this;
    }
    ...
    public GstPluginDesc field_minor_version(int field_minor_version) {
        this.io.setIntField(this, 1, field_minor_version);
        return this;
    }
    ...
    public GstPluginDesc field_release_datetime(Pointer field_release_datetime) {
        this.io.setPointerField(this, 4, field_release_datetime);
        return this;
    }

    @Field(5)
    public Pointer field_plugin_init() {
        return this.io.getPointerField(this, 5);
    }

    @Field(5)
    public GstPluginDesc field_plugin_init(Pointer field_plugin_init) {
        this.io.setPointerField(this, 5, field_plugin_init);
        return this;
    }
    ...
    @Field(6)
    private GstPluginDesc field__gst_reserved(Pointer field__gst_reserved) {
    ...
    public GstPluginDesc field_license(Pointer field_license) {
        this.io.setPointerField(this, 7, field_license);
        return this;
    }
    ...
    public GstPluginDesc field_package(Pointer field_package) {
        this.io.setPointerField(this, 8, field_package);
        return this;
    }
    ...
    public GstPluginDesc field_version(Pointer field_version) {
        this.io.setPointerField(this, 9, field_version);
        return this;
    }
    ...
    public GstPluginDesc field_origin(Pointer field_origin) {
        this.io.setPointerField(this, 10, field_origin);
        return this;
    }
    ...
    public GstPluginDesc field_source(Pointer field_source) {
        this.io.setPointerField(this, 11, field_source);
        return this;
    }
