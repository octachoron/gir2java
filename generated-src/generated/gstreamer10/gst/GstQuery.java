    ...
    extends StructObject
{
    ...
    @Field(0)
    public GstQuery field_mini_object(GstMiniObject field_mini_object) {
    ...
    public void parse_position(Pointer<IntValuedEnum<GstFormat>> format, Pointer<Long> cur) {
        this.gst_query_parse_position(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(format), Pointer.getPeer(cur));
    }
    ...
    public void parse_allocation(Pointer<Pointer<GstCaps>> caps, Pointer<Boolean> need_pool) {
        this.gst_query_parse_allocation(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(caps), Pointer.getPeer(need_pool));
    }
    ...
    public void parse_latency(Pointer<Boolean> live, Pointer<Object> min_latency, Pointer<Object> max_latency) {
        this.gst_query_parse_latency(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(live), Pointer.getPeer(min_latency), Pointer.getPeer(max_latency));
    }
    ...
    public void set_formatsv(int n_formats, IntValuedEnum<GstFormat> formats) {
        this.gst_query_set_formatsv(Pointer.pointerTo(this, GstQuery.class), n_formats, Pointer.getPeer(formats));
    }
    ...
    public void remove_nth_allocation_pool(long index) {
        this.gst_query_remove_nth_allocation_pool(Pointer.pointerTo(this, GstQuery.class), index);
    }
    ...
    public boolean find_allocation_meta(long api, Pointer<Long> index) {
        return this.gst_query_find_allocation_meta(Pointer.pointerTo(this, GstQuery.class), api, Pointer.getPeer(index));
    }
    ...
    public boolean parse_nth_buffering_range(long index, Pointer<Long> start, Pointer<Long> stop) {
        return this.gst_query_parse_nth_buffering_range(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(start), Pointer.getPeer(stop));
    }
    ...
    public void add_allocation_pool(Pointer<GstBufferPool> pool, long size, long min_buffers, long max_buffers) {
        this.gst_query_add_allocation_pool(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(pool), size, min_buffers, max_buffers);
    }
    ...
    public void set_position(IntValuedEnum<GstFormat> format, long cur) {
        this.gst_query_set_position(Pointer.pointerTo(this, GstQuery.class), format, cur);
    }
    ...
    public boolean add_buffering_range(long start, long stop) {
        return this.gst_query_add_buffering_range(Pointer.pointerTo(this, GstQuery.class), start, stop);
    }
    ...
    public void parse_seeking(Pointer<IntValuedEnum<GstFormat>> format, Pointer<Boolean> seekable, Pointer<Long> segment_start, Pointer<Long> segment_end) {
        this.gst_query_parse_seeking(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(format), Pointer.getPeer(seekable), Pointer.getPeer(segment_start), Pointer.getPeer(segment_end));
    }

    protected native void gst_query_set_scheduling(
        @Ptr
        long query, Object flags, int minsize, int maxsize, int align);

    public void set_scheduling(Object flags, int minsize, int maxsize, int align) {
        this.gst_query_set_scheduling(Pointer.pointerTo(this, GstQuery.class), flags, minsize, maxsize, align);
    }
    ...
    public void set_nth_allocation_param(long index, Pointer<GstAllocator> allocator, Pointer<GstAllocationParams> params) {
        this.gst_query_set_nth_allocation_param(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(allocator), Pointer.getPeer(params));
    }
    ...
    public long get_n_allocation_params() {
        return this.gst_query_get_n_allocation_params(Pointer.pointerTo(this, GstQuery.class));
    }
    ...
    public void set_nth_allocation_pool(long index, Pointer<GstBufferPool> pool, long size, long min_buffers, long max_buffers) {
        this.gst_query_set_nth_allocation_pool(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(pool), size, min_buffers, max_buffers);
    }
    ...
    public void set_buffering_percent(boolean busy, int percent) {
        this.gst_query_set_buffering_percent(Pointer.pointerTo(this, GstQuery.class), busy, percent);
    }
    ...
    public void parse_uri_redirection(Pointer uri) {
        this.gst_query_parse_uri_redirection(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(uri));
    }
    ...
    public long get_n_allocation_pools() {
        return this.gst_query_get_n_allocation_pools(Pointer.pointerTo(this, GstQuery.class));
    }
    ...
    public void remove_nth_allocation_meta(long index) {
        this.gst_query_remove_nth_allocation_meta(Pointer.pointerTo(this, GstQuery.class), index);
    }
    ...
    public Pointer<GstStructure> writable_structure() {
        return Pointer.pointerToAddress(this.gst_query_writable_structure(Pointer.pointerTo(this, GstQuery.class)), Pointer.class);
    }
    ...
    public long get_n_scheduling_modes() {
        return this.gst_query_get_n_scheduling_modes(Pointer.pointerTo(this, GstQuery.class));
    }
    ...
    public void parse_buffering_stats(Pointer<IntValuedEnum<GstBufferingMode>> mode, Pointer<Integer> avg_in, Pointer<Integer> avg_out, Pointer<Long> buffering_left) {
        this.gst_query_parse_buffering_stats(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(mode), Pointer.getPeer(avg_in), Pointer.getPeer(avg_out), Pointer.getPeer(buffering_left));
    }
    ...
    public void set_duration(IntValuedEnum<GstFormat> format, long duration) {
        this.gst_query_set_duration(Pointer.pointerTo(this, GstQuery.class), format, duration);
    }
    ...
    public void parse_caps(Pointer<Pointer<GstCaps>> filter) {
        this.gst_query_parse_caps(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(filter));
    }
    ...
    public Pointer<GstStructure> get_structure() {
        return Pointer.pointerToAddress(this.gst_query_get_structure(Pointer.pointerTo(this, GstQuery.class)), Pointer.class);
    }
    ...
    public void set_accept_caps_result(boolean result) {
        this.gst_query_set_accept_caps_result(Pointer.pointerTo(this, GstQuery.class), result);
    }
    ...
    public void parse_nth_format(long nth, Pointer<IntValuedEnum<GstFormat>> format) {
        this.gst_query_parse_nth_format(Pointer.pointerTo(this, GstQuery.class), nth, Pointer.getPeer(format));
    }
    ...
    public void set_uri_redirection(Pointer uri) {
        this.gst_query_set_uri_redirection(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(uri));
    }
    ...
    public void parse_context(Pointer<Pointer<GstContext>> context) {
        this.gst_query_parse_context(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(context));
    }
    ...
    public void parse_scheduling(Pointer<Object> flags, Pointer<Integer> minsize, Pointer<Integer> maxsize, Pointer<Integer> align) {
        this.gst_query_parse_scheduling(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(flags), Pointer.getPeer(minsize), Pointer.getPeer(maxsize), Pointer.getPeer(align));
    }
    ...
    public void parse_buffering_range(Pointer<IntValuedEnum<GstFormat>> format, Pointer<Long> start, Pointer<Long> stop, Pointer<Long> estimated_total) {
        this.gst_query_parse_buffering_range(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(format), Pointer.getPeer(start), Pointer.getPeer(stop), Pointer.getPeer(estimated_total));
    }
    ...
    public void parse_buffering_percent(Pointer<Boolean> busy, Pointer<Integer> percent) {
        this.gst_query_parse_buffering_percent(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(busy), Pointer.getPeer(percent));
    }
    ...
    public void parse_caps_result(Pointer<Pointer<GstCaps>> caps) {
        this.gst_query_parse_caps_result(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(caps));
    }
    ...
    public void parse_nth_allocation_pool(long index, Pointer<Pointer<GstBufferPool>> pool, Pointer<Long> size, Pointer<Long> min_buffers, Pointer<Long> max_buffers) {
        this.gst_query_parse_nth_allocation_pool(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(pool), Pointer.getPeer(size), Pointer.getPeer(min_buffers), Pointer.getPeer(max_buffers));
    }
    ...
    public void parse_nth_allocation_param(long index, Pointer<Pointer<GstAllocator>> allocator, Pointer<GstAllocationParams> params) {
        this.gst_query_parse_nth_allocation_param(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(allocator), Pointer.getPeer(params));
    }
    ...
    public void remove_nth_allocation_param(long index) {
        this.gst_query_remove_nth_allocation_param(Pointer.pointerTo(this, GstQuery.class), index);
    }
    ...
    public boolean parse_context_type(Pointer context_type) {
        return this.gst_query_parse_context_type(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(context_type));
    }
    ...
    public void set_buffering_stats(IntValuedEnum<GstBufferingMode> mode, int avg_in, int avg_out, long buffering_left) {
        this.gst_query_set_buffering_stats(Pointer.pointerTo(this, GstQuery.class), mode, avg_in, avg_out, buffering_left);
    }
    ...
    public long parse_nth_allocation_meta(long index, Pointer<Pointer<GstStructure>> params) {
        return this.gst_query_parse_nth_allocation_meta(Pointer.pointerTo(this, GstQuery.class), index, Pointer.getPeer(params));
    }
    ...
    public void set_convert(IntValuedEnum<GstFormat> src_format, long src_value, IntValuedEnum<GstFormat> dest_format, long dest_value) {
        this.gst_query_set_convert(Pointer.pointerTo(this, GstQuery.class), src_format, src_value, dest_format, dest_value);
    }
    ...
    public long get_n_allocation_metas() {
        return this.gst_query_get_n_allocation_metas(Pointer.pointerTo(this, GstQuery.class));
    }
    ...
    public long get_n_buffering_ranges() {
        return this.gst_query_get_n_buffering_ranges(Pointer.pointerTo(this, GstQuery.class));
    }
    ...
    public void parse_segment(Pointer<Double> rate, Pointer<IntValuedEnum<GstFormat>> format, Pointer<Long> start_value, Pointer<Long> stop_value) {
        this.gst_query_parse_segment(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(rate), Pointer.getPeer(format), Pointer.getPeer(start_value), Pointer.getPeer(stop_value));
    }
    ...
    public void parse_accept_caps(Pointer<Pointer<GstCaps>> caps) {
        this.gst_query_parse_accept_caps(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(caps));
    }
    ...
    public void parse_n_formats(Pointer<Long> n_formats) {
        this.gst_query_parse_n_formats(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(n_formats));
    }
    ...
    public void set_context(Pointer<GstContext> context) {
        this.gst_query_set_context(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(context));
    }
    ...
    public void set_segment(double rate, IntValuedEnum<GstFormat> format, long start_value, long stop_value) {
        this.gst_query_set_segment(Pointer.pointerTo(this, GstQuery.class), rate, format, start_value, stop_value);
    }
    ...
    public void parse_duration(Pointer<IntValuedEnum<GstFormat>> format, Pointer<Long> duration) {
        this.gst_query_parse_duration(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(format), Pointer.getPeer(duration));
    }
    ...
    public IntValuedEnum<GstPadMode> parse_nth_scheduling_mode(long index) {
        return this.gst_query_parse_nth_scheduling_mode(Pointer.pointerTo(this, GstQuery.class), index);
    }

    protected native void gst_query_set_latency(
        @Ptr
        long query, boolean live, Object min_latency, Object max_latency);

    public void set_latency(boolean live, Object min_latency, Object max_latency) {
        this.gst_query_set_latency(Pointer.pointerTo(this, GstQuery.class), live, min_latency, max_latency);
    }
    ...
    public void set_caps_result(Pointer<GstCaps> caps) {
        this.gst_query_set_caps_result(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(caps));
    }
    ...
    public void parse_accept_caps_result(Pointer<Boolean> result) {
        this.gst_query_parse_accept_caps_result(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(result));
    }

    @Field(1)
    public IntValuedEnum<GstQueryType> field_type() {
        return this.io.getEnumField(this, 1);
    }

    @Field(1)
    public GstQuery field_type(IntValuedEnum<GstQueryType> field_type) {
    ...
    public void set_seeking(IntValuedEnum<GstFormat> format, boolean seekable, long segment_start, long segment_end) {
        this.gst_query_set_seeking(Pointer.pointerTo(this, GstQuery.class), format, seekable, segment_start, segment_end);
    }
    ...
    public void parse_uri(Pointer uri) {
        this.gst_query_parse_uri(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(uri));
    }
    ...
    public void set_formats(int n_formats, Object... varargs) {
        this.gst_query_set_formats(Pointer.pointerTo(this, GstQuery.class), n_formats, varargs);
    }
    ...
    public boolean has_scheduling_mode(IntValuedEnum<GstPadMode> mode) {
        return this.gst_query_has_scheduling_mode(Pointer.pointerTo(this, GstQuery.class), mode);
    }
    ...
    public void set_uri(Pointer uri) {
        this.gst_query_set_uri(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(uri));
    }
    ...
    public void parse_convert(Pointer<IntValuedEnum<GstFormat>> src_format, Pointer<Long> src_value, Pointer<IntValuedEnum<GstFormat>> dest_format, Pointer<Long> dest_value) {
        this.gst_query_parse_convert(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(src_format), Pointer.getPeer(src_value), Pointer.getPeer(dest_format), Pointer.getPeer(dest_value));
    }
    ...
    public void set_buffering_range(IntValuedEnum<GstFormat> format, long start, long stop, long estimated_total) {
        this.gst_query_set_buffering_range(Pointer.pointerTo(this, GstQuery.class), format, start, stop, estimated_total);
    }
    ...
    public void add_allocation_meta(long api, Pointer<GstStructure> params) {
        this.gst_query_add_allocation_meta(Pointer.pointerTo(this, GstQuery.class), api, Pointer.getPeer(params));
    }
    ...
    public void add_scheduling_mode(IntValuedEnum<GstPadMode> mode) {
        this.gst_query_add_scheduling_mode(Pointer.pointerTo(this, GstQuery.class), mode);
    }

    protected native boolean gst_query_has_scheduling_mode_with_flags(
        @Ptr
        long query, IntValuedEnum<GstPadMode> mode, Object flags);

    public boolean has_scheduling_mode_with_flags(IntValuedEnum<GstPadMode> mode, Object flags) {
        return this.gst_query_has_scheduling_mode_with_flags(Pointer.pointerTo(this, GstQuery.class), mode, flags);
    }
    ...
    public void add_allocation_param(Pointer<GstAllocator> allocator, Pointer<GstAllocationParams> params) {
        this.gst_query_add_allocation_param(Pointer.pointerTo(this, GstQuery.class), Pointer.getPeer(allocator), Pointer.getPeer(params));
    }
