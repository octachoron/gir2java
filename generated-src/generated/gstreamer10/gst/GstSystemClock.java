    ...
    extends GstClock
{
    ...
    @Field(1)
    private Pointer<GstSystemClockPrivate> gstsystemclock_field_priv() {
        return this.io.getPointerField(this, 1);
    }

    @Field(1)
    private GstSystemClock gstsystemclock_field_priv(Pointer<GstSystemClockPrivate> gstsystemclock_field_priv) {
