    ...
    extends GstObject
{
    ...
    @Field(2)
    public GstTask field_func(Pointer field_func) {
        this.io.setPointerField(this, 2, field_func);
        return this;
    }

    @Field(3)
    private Pointer<GThread> field_thread() {
        return this.io.getPointerField(this, 3);
    }

    @Field(3)
    private GstTask field_thread(Pointer<GThread> field_thread) {
        this.io.setPointerField(this, 3, field_thread);
        return this;
    }
    ...
    public GstTask field_state(IntValuedEnum<GstTaskState> field_state) {
        this.io.setEnumField(this, 4, field_state);
        return this;
    }

    @Field(5)
    private Pointer<GstTaskPrivate> field_priv() {
        return this.io.getPointerField(this, 5);
    }

    @Field(5)
    private GstTask field_priv(Pointer<GstTaskPrivate> field_priv) {
    ...
    public GstTask field_running(boolean field_running) {
        this.io.setBooleanField(this, 7, field_running);
        return this;
    }
    ...
    @Field(8)
    public GstTask field_notify(Pointer field_notify) {
        this.io.setPointerField(this, 8, field_notify);
        return this;
    }
    ...
    public GstTask field_user_data(Pointer field_user_data) {
        this.io.setPointerField(this, 9, field_user_data);
        return this;
    }
    ...
    private GstTask gsttask_field__gst_reserved(Pointer gsttask_field__gst_reserved) {
        this.io.setPointerField(this, 10, gsttask_field__gst_reserved);
        return this;
    }
