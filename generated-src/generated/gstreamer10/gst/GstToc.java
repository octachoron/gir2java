    ...
    extends StructObject
{
    ...
    public void append_entry(Pointer entry) {
        this.gst_toc_append_entry(Pointer.pointerTo(this, GstToc.class), Pointer.getPeer(entry));
    }
    ...
    public void dump() {
        this.gst_toc_dump(Pointer.pointerTo(this, GstToc.class));
    }
    ...
    public Pointer find_entry(Pointer uid) {
        return Pointer.pointerToAddress(this.gst_toc_find_entry(Pointer.pointerTo(this, GstToc.class), Pointer.getPeer(uid)));
    }
    ...
    public Pointer<GList> get_entries() {
        return Pointer.pointerToAddress(this.gst_toc_get_entries(Pointer.pointerTo(this, GstToc.class)), Pointer.class);
    }
    ...
    public Pointer<GstTagList> get_tags() {
        return Pointer.pointerToAddress(this.gst_toc_get_tags(Pointer.pointerTo(this, GstToc.class)), Pointer.class);
    }
    ...
    public void merge_tags(Pointer<GstTagList> tags, IntValuedEnum<GstTagMergeMode> mode) {
        this.gst_toc_merge_tags(Pointer.pointerTo(this, GstToc.class), Pointer.getPeer(tags), mode);
    }
    ...
    public void set_tags(Pointer<GstTagList> tags) {
        this.gst_toc_set_tags(Pointer.pointerTo(this, GstToc.class), Pointer.getPeer(tags));
    }
    ...
    public IntValuedEnum<GstTocScope> get_scope() {
        return this.gst_toc_get_scope(Pointer.pointerTo(this, GstToc.class));
    }
