    ...
    extends GstElement
{
    ...
    public IntValuedEnum<GstFlowReturn> do_preroll(Pointer<GstMiniObject> obj) {
        return this.gst_base_sink_do_preroll(Pointer.pointerTo(this, GstBaseSink.class), Pointer.getPeer(obj));
    }
    ...
    public long get_blocksize() {
        return this.gst_base_sink_get_blocksize(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public Pointer<GstSample> get_last_sample() {
        return Pointer.pointerToAddress(this.gst_base_sink_get_last_sample(Pointer.pointerTo(this, GstBaseSink.class)), Pointer.class);
    }

    protected native Object gst_base_sink_get_latency(
        @Ptr
        long sink);

    public Object get_latency() {
        return this.gst_base_sink_get_latency(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public long get_max_bitrate() {
        return this.gst_base_sink_get_max_bitrate(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public long get_max_lateness() {
        return this.gst_base_sink_get_max_lateness(Pointer.pointerTo(this, GstBaseSink.class));
    }

    protected native Object gst_base_sink_get_render_delay(
        @Ptr
        long sink);

    public Object get_render_delay() {
        return this.gst_base_sink_get_render_delay(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public boolean get_sync() {
        return this.gst_base_sink_get_sync(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public long get_throttle_time() {
        return this.gst_base_sink_get_throttle_time(Pointer.pointerTo(this, GstBaseSink.class));
    }

    protected native Object gst_base_sink_get_ts_offset(
        @Ptr
        long sink);

    public Object get_ts_offset() {
        return this.gst_base_sink_get_ts_offset(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public boolean is_async_enabled() {
        return this.gst_base_sink_is_async_enabled(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public boolean is_last_sample_enabled() {
        return this.gst_base_sink_is_last_sample_enabled(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public boolean is_qos_enabled() {
        return this.gst_base_sink_is_qos_enabled(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public boolean query_latency(Pointer<Boolean> live, Pointer<Boolean> upstream_live, Pointer<Object> min_latency, Pointer<Object> max_latency) {
        return this.gst_base_sink_query_latency(Pointer.pointerTo(this, GstBaseSink.class), Pointer.getPeer(live), Pointer.getPeer(upstream_live), Pointer.getPeer(min_latency), Pointer.getPeer(max_latency));
    }
    ...
    public void set_async_enabled(boolean enabled) {
        this.gst_base_sink_set_async_enabled(Pointer.pointerTo(this, GstBaseSink.class), enabled);
    }
    ...
    public void set_blocksize(long blocksize) {
        this.gst_base_sink_set_blocksize(Pointer.pointerTo(this, GstBaseSink.class), blocksize);
    }
    ...
    public void set_last_sample_enabled(boolean enabled) {
        this.gst_base_sink_set_last_sample_enabled(Pointer.pointerTo(this, GstBaseSink.class), enabled);
    }
    ...
    public void set_max_bitrate(long max_bitrate) {
        this.gst_base_sink_set_max_bitrate(Pointer.pointerTo(this, GstBaseSink.class), max_bitrate);
    }
    ...
    public void set_max_lateness(long max_lateness) {
        this.gst_base_sink_set_max_lateness(Pointer.pointerTo(this, GstBaseSink.class), max_lateness);
    }
    ...
    public void set_qos_enabled(boolean enabled) {
        this.gst_base_sink_set_qos_enabled(Pointer.pointerTo(this, GstBaseSink.class), enabled);
    }

    protected native void gst_base_sink_set_render_delay(
        @Ptr
        long sink, Object delay);

    public void set_render_delay(Object delay) {
        this.gst_base_sink_set_render_delay(Pointer.pointerTo(this, GstBaseSink.class), delay);
    }
    ...
    public void set_sync(boolean sync) {
        this.gst_base_sink_set_sync(Pointer.pointerTo(this, GstBaseSink.class), sync);
    }
    ...
    public void set_throttle_time(long throttle) {
        this.gst_base_sink_set_throttle_time(Pointer.pointerTo(this, GstBaseSink.class), throttle);
    }

    protected native void gst_base_sink_set_ts_offset(
        @Ptr
        long sink, Object offset);

    public void set_ts_offset(Object offset) {
        this.gst_base_sink_set_ts_offset(Pointer.pointerTo(this, GstBaseSink.class), offset);
    }

    protected native IntValuedEnum<GstFlowReturn> gst_base_sink_wait(
        @Ptr
        long sink, Object time,
        @Ptr
        long jitter);

    public IntValuedEnum<GstFlowReturn> wait(Object time, Pointer<Object> jitter) {
        return this.gst_base_sink_wait(Pointer.pointerTo(this, GstBaseSink.class), time, Pointer.getPeer(jitter));
    }
    ...
    public IntValuedEnum<GstClockReturn> wait_clock(Object time, Pointer<Object> jitter) {
        return this.gst_base_sink_wait_clock(Pointer.pointerTo(this, GstBaseSink.class), time, Pointer.getPeer(jitter));
    }
    ...
    public IntValuedEnum<GstFlowReturn> wait_preroll() {
        return this.gst_base_sink_wait_preroll(Pointer.pointerTo(this, GstBaseSink.class));
    }
    ...
    public GstBaseSink field_can_activate_pull(boolean field_can_activate_pull) {
        this.io.setNativeObjectField(this, 4, field_can_activate_pull);
        return this;
    }
    ...
    public GstBaseSink field_can_activate_push(boolean field_can_activate_push) {
        this.io.setNativeObjectField(this, 5, field_can_activate_push);
        return this;
    }

    @Field(6)
    public Object field_preroll_lock() {
        return this.io.getNativeObjectField(this, 6);
    }

    @Field(6)
    public GstBaseSink field_preroll_lock(Object field_preroll_lock) {
    ...
    public GstBaseSink field_eos(boolean field_eos) {
        this.io.setNativeObjectField(this, 8, field_eos);
        return this;
    }
    ...
    public GstBaseSink field_need_preroll(boolean field_need_preroll) {
        this.io.setNativeObjectField(this, 9, field_need_preroll);
        return this;
    }
    ...
    public GstBaseSink field_have_preroll(boolean field_have_preroll) {
        this.io.setNativeObjectField(this, 10, field_have_preroll);
        return this;
    }
    ...
    public GstBaseSink field_playing_async(boolean field_playing_async) {
        this.io.setNativeObjectField(this, 11, field_playing_async);
        return this;
    }
    ...
    public GstBaseSink field_have_newsegment(boolean field_have_newsegment) {
        this.io.setNativeObjectField(this, 12, field_have_newsegment);
        return this;
    }
    ...
    @Field(14)
    public GstBaseSink field_clock_id(Object field_clock_id) {
        this.io.setNativeObjectField(this, 14, field_clock_id);
        return this;
    }

    @Field(15)
    public boolean field_sync() {
        return this.io.getNativeObjectField(this, 15);
    }

    @Field(15)
    public GstBaseSink field_sync(boolean field_sync) {
        this.io.setNativeObjectField(this, 15, field_sync);
        return this;
    }
    ...
    @Field(16)
    public GstBaseSink field_flushing(boolean field_flushing) {
        this.io.setNativeObjectField(this, 16, field_flushing);
        return this;
    }
    ...
    @Field(17)
    public GstBaseSink field_running(boolean field_running) {
        this.io.setNativeObjectField(this, 17, field_running);
        return this;
    }

    @Field(18)
    public long field_max_lateness() {
        return this.io.getNativeObjectField(this, 18);
    }

    @Field(18)
    public GstBaseSink field_max_lateness(long field_max_lateness) {
        this.io.setNativeObjectField(this, 18, field_max_lateness);
        return this;
    }
    ...
    @Field(19)
    public GstBaseSink field_priv(Pointer field_priv) {
    ...
    @Field(20)
    public GstBaseSink field__gst_reserved(Pointer field__gst_reserved) {
        this.io.setPointerField(this, 20, field__gst_reserved);
        return this;
    }
