    ...
    extends GObject
{
    ...
    public boolean drop_head(long type) {
        return this.gst_data_queue_drop_head(Pointer.pointerTo(this, GstDataQueue.class), type);
    }
    ...
    public void flush() {
        this.gst_data_queue_flush(Pointer.pointerTo(this, GstDataQueue.class));
    }
    ...
    public void get_level(Pointer level) {
        this.gst_data_queue_get_level(Pointer.pointerTo(this, GstDataQueue.class), Pointer.getPeer(level));
    }
    ...
    public boolean is_empty() {
        return this.gst_data_queue_is_empty(Pointer.pointerTo(this, GstDataQueue.class));
    }
    ...
    public boolean is_full() {
        return this.gst_data_queue_is_full(Pointer.pointerTo(this, GstDataQueue.class));
    }
    ...
    public void limits_changed() {
        this.gst_data_queue_limits_changed(Pointer.pointerTo(this, GstDataQueue.class));
    }
    ...
    public boolean peek(Pointer item) {
        return this.gst_data_queue_peek(Pointer.pointerTo(this, GstDataQueue.class), Pointer.getPeer(item));
    }
    ...
    public boolean pop(Pointer item) {
        return this.gst_data_queue_pop(Pointer.pointerTo(this, GstDataQueue.class), Pointer.getPeer(item));
    }
    ...
    public boolean push(Pointer item) {
        return this.gst_data_queue_push(Pointer.pointerTo(this, GstDataQueue.class), Pointer.getPeer(item));
    }
    ...
    public boolean push_force(Pointer item) {
        return this.gst_data_queue_push_force(Pointer.pointerTo(this, GstDataQueue.class), Pointer.getPeer(item));
    }
    ...
    public void set_flushing(boolean flushing) {
        this.gst_data_queue_set_flushing(Pointer.pointerTo(this, GstDataQueue.class), flushing);
    }
    ...
    @Field(1)
    public GstDataQueue field_priv(Pointer field_priv) {
    ...
    @Field(2)
    public GstDataQueue field__gst_reserved(Pointer field__gst_reserved) {
