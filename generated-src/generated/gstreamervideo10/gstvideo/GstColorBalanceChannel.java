    ...
    extends GObject
{
    ...
    public GstColorBalanceChannel field_min_value(int field_min_value) {
        this.io.setNativeObjectField(this, 2, field_min_value);
        return this;
    }
    ...
    public GstColorBalanceChannel field_max_value(int field_max_value) {
        this.io.setNativeObjectField(this, 3, field_max_value);
        return this;
    }
    ...
    @Field(4)
    public GstColorBalanceChannel field__gst_reserved(Pointer field__gst_reserved) {
