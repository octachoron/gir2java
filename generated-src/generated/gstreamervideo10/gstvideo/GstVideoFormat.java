...
public enum GstVideoFormat
    implements IntValuedEnum<GstVideoFormat>
{
    ...
    public static IntValuedEnum<GstVideoFormat> fromValue(long value) {
    ...
    public Pointer<GstVideoFormatInfo> get_info(IntValuedEnum<GstVideoFormat> format) {
    ...
    public Pointer to_string(IntValuedEnum<GstVideoFormat> format) {
        return Pointer.pointerToAddress(this.gst_video_format_to_string(format));
    }

    protected native Pointer gst_video_format_get_palette(IntValuedEnum<GstVideoFormat> format,
        @Ptr
        long size);

    public Pointer get_palette(IntValuedEnum<GstVideoFormat> format, Pointer<Long> size) {
        return this.gst_video_format_get_palette(format, Pointer.getPeer(size));
    }
    ...
    public IntValuedEnum<GstVideoFormat> from_string(Pointer format) {
