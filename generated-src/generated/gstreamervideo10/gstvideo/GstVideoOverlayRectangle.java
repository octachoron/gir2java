    ...
    extends StructObject
{
    ...
    public Pointer copy() {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_copy(Pointer.pointerTo(this, GstVideoOverlayRectangle.class)));
    }
    ...
    public IntValuedEnum<GstVideoOverlayFormatFlags> get_flags() {
        return this.gst_video_overlay_rectangle_get_flags(Pointer.pointerTo(this, GstVideoOverlayRectangle.class));
    }
    ...
    public float get_global_alpha() {
        return this.gst_video_overlay_rectangle_get_global_alpha(Pointer.pointerTo(this, GstVideoOverlayRectangle.class));
    }
    ...
    public Pointer<GstBuffer> get_pixels_argb(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_argb(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public Pointer<GstBuffer> get_pixels_ayuv(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_ayuv(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public Pointer<GstBuffer> get_pixels_raw(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_raw(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public Pointer<GstBuffer> get_pixels_unscaled_argb(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_unscaled_argb(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public Pointer<GstBuffer> get_pixels_unscaled_ayuv(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_unscaled_ayuv(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public Pointer<GstBuffer> get_pixels_unscaled_raw(IntValuedEnum<GstVideoOverlayFormatFlags> flags) {
        return Pointer.pointerToAddress(this.gst_video_overlay_rectangle_get_pixels_unscaled_raw(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), flags), Pointer.class);
    }
    ...
    public boolean get_render_rectangle(Pointer<Integer> render_x, Pointer<Integer> render_y, Pointer<Long> render_width, Pointer<Long> render_height) {
        return this.gst_video_overlay_rectangle_get_render_rectangle(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), Pointer.getPeer(render_x), Pointer.getPeer(render_y), Pointer.getPeer(render_width), Pointer.getPeer(render_height));
    }
    ...
    public long get_seqnum() {
        return this.gst_video_overlay_rectangle_get_seqnum(Pointer.pointerTo(this, GstVideoOverlayRectangle.class));
    }
    ...
    public void set_global_alpha(float global_alpha) {
        this.gst_video_overlay_rectangle_set_global_alpha(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), global_alpha);
    }
    ...
    public void set_render_rectangle(int render_x, int render_y, long render_width, long render_height) {
        this.gst_video_overlay_rectangle_set_render_rectangle(Pointer.pointerTo(this, GstVideoOverlayRectangle.class), render_x, render_y, render_width, render_height);
    }
